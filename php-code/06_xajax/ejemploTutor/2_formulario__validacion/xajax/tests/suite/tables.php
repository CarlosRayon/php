...
if (false == class_exists('xajaxControl')) {
    ...
    require $folderControls . '/content.inc.php';
    require $folderControls . '/group.inc.php';
    require $folderControls . '/misc.inc.php';

    $xajax->processRequest();

    require $folderControls . '/form.inc.php';
...
function premadeTable()
{
    ...
    $anchorReplaceRow = new clsAnchor(
        array(
    ...
    $anchorRemoveColumn = new clsAnchor(
        array(
    ...
    $anchorReplaceColumn = new clsAnchor(
        array(
    ...
    $anchorInsertColumn = new clsAnchor(
        array(
    ...
    $anchorSetCellValue = new clsAnchor(
        array(
    ...
    $anchorSetCellProperty = new clsAnchor(
        array(
    ...
    $anchorSetRowProperty = new clsAnchor(
        array(
        'children' => array(new clsLiteral('Set Property'))
        )
    );
    ...
    $anchorSetColumnProperty = new clsAnchor(
        array(
        'children' => array(new clsLiteral('Set Property'))
        )
    );
