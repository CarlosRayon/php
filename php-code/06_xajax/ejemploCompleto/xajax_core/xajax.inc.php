...
final class xajax
{
    ...
    */
    public function __wakeup()
    {
        ...
        //SkipAIO
        include $sLocalFolder . '/xajaxPluginManager.inc.php';
        include $sLocalFolder . '/xajaxLanguageManager.inc.php';
        include $sLocalFolder . '/xajaxArgumentManager.inc.php';
        include $sLocalFolder . '/xajaxResponseManager.inc.php';
        include $sLocalFolder . '/xajaxRequest.inc.php';
        include $sLocalFolder . '/xajaxResponse.inc.php';
        //EndSkipAIO
    ...
    */
    public function autoCompressJavascript($sJsFullFilename=null, $bAlways=false)
    {
        ...
        if (!file_exists($realJsFile) || true == $bAlways) {
            ...
            include_once dirname(__FILE__) . '/xajaxCompress.inc.php';
