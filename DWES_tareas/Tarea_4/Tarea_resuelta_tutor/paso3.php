...
function mostrarModulosElegidos() { // muestra los módulos elegidos		
...
function mostrarHorasMatriculadas() { //calcula y muestra el total de horas de los módulos
...
function borrarDatosAlumno() { //inicializa los módulos elegidos por el alumno actual        
