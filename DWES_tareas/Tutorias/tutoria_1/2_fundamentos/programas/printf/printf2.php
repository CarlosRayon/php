...
$nombre="juan";$apellido="lopez";$edad=25; 
 printf ("el nombre es %s, el apellido es %s y tiene %d años", $nombre, $apellido, $edad); 
 echo "<BR>";
 $mascara="con masca: el nombre es %s, el apellido es %s y tiene %d años";
 printf ($mascara, $nombre, $apellido, $edad);
  echo "<BR>";
 printf("%d se deborda",10023123553.45634663);   // desbordamiento al truncar a entero
 echo "<BR>";
