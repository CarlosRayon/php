...
include_once './clases/Estaticos.php';
include_once './clases/Modulo.php';
include_once './clases/Comun.php';
...
if (isset($_GET["enviar"])) {//Ya he validado los campos por HTML5 y son todos requeridos 
    ...
    $moduloComun = new Comun($cod, $nombre, $horas, $curso, $plazas, $codigo, $departamento);
...
$tablaModulos = Estaticos::mostrarModulos(BaseDatos::listaModulos());

//Asignamos las variables para mostrar en plantilla smarty
$smarty->assign('tablamodulos', $tablaModulos); //Asigno la variable con la informacion a una variable de smarty para mostrar en el template
