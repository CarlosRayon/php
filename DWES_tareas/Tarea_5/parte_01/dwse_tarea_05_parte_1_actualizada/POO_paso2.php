...
include_once './clases/Seleccion.php';
...
/* Creo una variable de session con los modulos del ciclo seleccionado SOLO cuando venga de POO_paso1
  de esta menera evito la redundancia de datos en esta variable de session 
 */
if (isset($_GET["irpaso2"])) {
...
if (isset($_GET["insertar"])) {
    $_SESSION["seleccion"]->añadirModulo2($_GET["insertar"]);
}
...
if (isset($_GET["todos"])) {
    $_SESSION["seleccion"]->añadirTodosModulos();
}
        ...
        <section>
            <div id="modulos">
                ...
                <div id="moduloscandidatos">
                    ...
                    Estaticos::mostrarModulosCandidatos();
                    echo "</form>";
                    ?>               
                </div>
