...
<ul id="ul-jornadas">
        ...
        <li class="jornada"> Jornada  <?= $jornada ?> </li>

        <?php foreach ($partidos as $indice => $equipo) : ?>
        <?php $valorJornadas = ($indice % 2) ? "par" : "impar"; ?>

        <li class="<?= $valorJornadas ?>">
                <span class=" <?php if($equipo[0]['nombre'] == "Descanso" ){echo "descanso";} ?>">
                <?= $equipo[0]['nombre'] ?>
                </span>
                 <span class=" <?php if($equipo[1]['nombre'] == "Descanso" ){echo "descanso";} ?> ">
                  <?= $equipo[1]['nombre'] ?>
                 </span>
        </li>
