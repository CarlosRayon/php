...
if (!is_callable('smarty_function_html_options')) require_once 'C:\\xampp\\htdocs\\PHP\\PHP\\04_smarty\\smarty\\libs\\plugins\\function.html_options.php';
?>
<!DOCTYPE html>
<!--
...
<html>
    ...
    <body>
        <div>
            ...
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['paises']->value, 'pais', false, 'key', 'propiedades', array (
  'iteration' => true,
));
if ($_from !== null) {
...
?>
            ...
            <table>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['paises']->value, 'pais', false, NULL, 'propiedades', array (
  'iteration' => true,
));
if ($_from !== null) {
