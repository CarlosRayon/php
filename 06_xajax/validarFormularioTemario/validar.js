...
$("#datos").submit(function(){//Capturo formulario y al hacer submit
    if(validar()) return true;//Si validar es true mandamos el  formulario
    else return false;//Si es false no le mandamos
});
