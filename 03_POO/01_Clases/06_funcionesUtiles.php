...
if($objetoPrueba instanceof Prueba) echo "es de la clase"; else echo "no es de la clase";
 ...
 */
if (class_exists('Prueba')) echo "existe"; else echo "no existe";
...
if($objetoPrueba2 instanceof Prueba) echo "es de la clase"; else echo "no es de la clase";//Que sera de la misma clase...
...
if(method_exists("Prueba", "getAtributo")) echo "el metodo existe"; else echo "el metodo no existe";
...
if (property_exists("Prueba", "atributoPruebaPrivado")) echo "la propiedad si exite";else echo "la propiedad no existe";
