...
<?php
                ...
                new clsDiv(
                    ...
                    'children' => array(
                        ...
                        new clsDiv(
                            ...
                            "children" => array(
                            new clsInputWithLabel(
                                'Enable Debugging', 'right', array(
                                'attributes' => array(
                                    'type' => 'checkbox',
                                    'name' => 'debug',
                                    'id' => 'debug',
                            ...
                            $brk,
                            new clsInputWithLabel(
                                'Enable Verbose Debugging', 'right', array(
                                'attributes' => array(
                                    'type' => 'checkbox',
                                    'name' => 'verbose',
                                    'id' => 'verbose',
                            ...
                            $brk,
                            new clsInputWithLabel(
                                'Enable Status Messages', 'right', array(
                                'attributes' => array(
                                    'type' => 'checkbox',
                                    'name' => 'status',
                                    'id' => 'status',
                            ...
                            $brk,
                            new clsInputWithLabel(
                                'Set default mode to Synchronous', 'right', array(
                                'attributes' => array(
                                    'type' => 'checkbox',
                                    'name' => 'synchronous',
                                    'id' => 'synchronous',
                        ...
                        new clsDiv(
                            ...
                            new clsDiv(
                                ...
                                'children' => array(
                                    new clsInputWithLabel(
                                        'Load language module (en)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_en',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (de)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_de',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (es)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_es',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (fr)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_fr',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (nl)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_nl',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (tr)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_tr',
                                    ...
                                    $brk,
                                    new clsInputWithLabel(
                                        'Load language module (bg)', 'right', array(
                                        'attributes' => array(
                                            'type' => 'radio',
                                            'name' => 'lang',
                                            'id' => 'lang_bg',
    ...
    class clsRequests
    {
        ...
        function loadTests()
        {
            ...
            include $sControlsFolder . '/form.inc.php';
            include $sControlsFolder . '/content.inc.php';
