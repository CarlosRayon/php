...
if (false == class_exists('xajaxControl')) {
    ...
    require_once $sRoot . $sControls . '/document.inc.php';
    require_once $sRoot . $sControls . '/content.inc.php';
    require_once $sRoot . $sControls . '/group.inc.php';
    require_once $sRoot . $sControls . '/form.inc.php';
    require_once $sRoot . $sControls . '/misc.inc.php';
    
    $buttonLoadCSS1 = new clsButton(
        array(
        'attributes' => array(
            'class' => 'loadCSS1',
            'id' => 'loadCSS1'
    ...
    $buttonUnloadCSS1 = new clsButton(
        array(
        'attributes' => array(
    ...
    $buttonUnloadCSS2 = new clsButton(
        array(
        'attributes' => array(
    ...
    $buttonLoadCSS1_Print = new clsButton(
        array(
        'attributes' => array(
    ...
    $buttonUnloadCSS1_Print = new clsButton(
        array(
        'attributes' => array(
    ...
    $buttonLoadCSS2_Print = new clsButton(
        array(
        'attributes' => array(
    ...
    $buttonUnloadCSS2_Print = new clsButton(
        array(
        'attributes' => array(
