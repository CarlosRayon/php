...
require $sBaseFolder . $sCoreFolder . '/xajax.inc.php';

$xajax = new xajax();

$xajax->configure('javascript URI', '../../');

require $sBaseFolder . $sCtrlFolder . '/validate_HTML401TRANSITIONAL.inc.php';
require $sBaseFolder . $sCoreFolder . '/xajaxControl.inc.php';
