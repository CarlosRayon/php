    ...
    */
    function addOptions($aOptions, $aFields=array())
    {
        if (0 == count($aFields)) {
            ...
            trigger_error(
                'Invalid list of fields passed to clsSelect::addOptions; should be array of two strings.'
                . $this->backtrace(),
                E_USER_ERROR
            );
        }
    ...
    */
    function addOptions($aOptions, $aFields=array())
    {
        if (0 == count($aFields)) {
            ...
            trigger_error(
                'Invalid list of fields passed to clsOptionGroup::addOptions; should be array of two strings.'
                . $this->backtrace(),
                E_USER_ERROR
            );
        }
