...
class Estaticos
{
    ...
    public static function mostrarModulosCandidatos()
    {
        $modulosCandidatos = "<ul>";
        for ($i = 0; $i < count($_SESSION["listaModulos"]); $i++) {
            $modulosCandidatos .= "<li>" . $_SESSION["listaModulos"][$i]["curso"] . "º " . $_SESSION["listaModulos"][$i]["nombre"] .
                    "<input type='submit' id='" . $_SESSION["listaModulos"][$i]["cod"] . "' name='insertar' value='" . $_SESSION["listaModulos"][$i]["cod"] . "'>
                                 </li>";
        }
    ...
    public static function mostrarDatosPersonales()
    {
        $mostraDatos = "<p><b>Nombre:</b> " . $_SESSION["alumno"]->getNombreAlumno() . "</p>";
        $mostraDatos .= "<p><b>Apellido:</b> " . $_SESSION["alumno"]->getApellidoAlumno() . "</p>";
        $mostraDatos .= "<p><b>DNI:</b> " . $_SESSION["alumno"]->getDniAlumno() . "</p>";
        $mostraDatos .= "<p><b>Sexo:</b> " . $_SESSION["alumno"]->getSexoAlumno() . "</p>";
        $mostraDatos .= "<p><b>Fecha Nacimiento:</b> " . $_SESSION["alumno"]->getFechaNacimiento() . "</p>";
        $mostraDatos .= "<p><b>Ciclo eleguido:</b> " . $_SESSION["alumno"]->getCicloAlumno() . "</p>";
        echo $mostraDatos;
    }
