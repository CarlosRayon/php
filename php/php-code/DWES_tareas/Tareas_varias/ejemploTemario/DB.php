...
class DB
{
    ...
    protected static function ejecutaConsulta($sql)
    {
        ...
        $dwes = new PDO($dsn, $usuario, $contrasena, $opc);//establece conexion
        $resultado = null;
        if (isset($dwes)) { $resultado = $dwes->query($sql);//ejecuta una consulta que le pasemos y devuelve los datos
        }
        return $resultado;
    }
