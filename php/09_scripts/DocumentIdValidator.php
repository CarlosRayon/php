...
{
    /**
     * Función obtenida de  http://www.sima.cat/nif.php
     *
     * Validar nif de países europeos y Número CIF personalizado (Por lo menos lo de España. No probados otros países europeos)
     *
     ...
     *                      4         invalid country
     */
    public function documentIdValidate(&$VAT, $COUNTRY = "ES")
    {
            ...
            case "SK":
                ...
                if ($CTR > "") :
                    ...
                    for ($I = 2; $I < strlen($NUM); $I++) :
                        $CHK = $CHK + $CHG[$I - 2] * substr($NUM, $I, 1);
                    endfor;
                    $CHK = 11 - $CHK % 11;
                    $CHK = ($CHK == 10 ? 0 : $CHK);
                    $CHK = ($CHK == 11 ? 1 : $CHK);
    ...
    /**
     * Valida que el string no tenga ningún espacio
     * @param string $data
     * @return bool
     */
    public function validateWhiteSpace(string $data): bool
    {
        if (strlen($data) != strLen(preg_replace('/\s+/', '', $data))) {
            return false;
        }
